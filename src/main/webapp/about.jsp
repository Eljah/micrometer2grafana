            ...
            <div class="carousel-inner">
               ...
               <div class="carousel-item">
                  ...
                  <div class="carousel-caption d-none d-md-block bg-dark mb-4">
                     ...
                     <p>
                        Paste the JSON as the new Grafana dashboard. We assume you have already set up the
                        <plain>Prometheus</plain>
                        as your datasource (otherwise set it up in the form)
                     </p>
                  </div>
               </div>
               <div class="carousel-item">
